package com.ql1d.verify.bgarefreshlayoutviewholder;
/**
 ...
 * 描述:慕课网下拉刷新风格
 */
public class VerifyHolder extends BGARefreshViewHolder {
    ...
    public VerifyHolder(Context context, boolean isLoadingMoreEnabled, boolean isRefreshEnabled) {
